...
function renderCurrentForecast(loc, weatherData, preview = false) {
    ...
    sun = slide.querySelector('.sun')
    sky = slide.querySelector('.sky')
    if (sunPositionDegree() < -180 || sunPositionDegree() > 0) {
        ...
        sun.style.webkitTransform = 'rotate(' + sunPositionDegree() + 'deg)';
        sun.style.mozTransform = 'rotate(' + sunPositionDegree() + 'deg)';
        sun.style.msTransform = 'rotate(' + sunPositionDegree() + 'deg)';
        sun.style.oTransform = 'rotate(' + sunPositionDegree() + 'deg)';
        sun.style.transform = 'rotate(' + sunPositionDegree() + 'deg)';
        sky.style.webkitTransform = 'rotate(' + sunPositionDegree() + 'deg)';
        sky.style.mozTransform = 'rotate(' + sunPositionDegree() + 'deg)';
        sky.style.msTransform = 'rotate(' + sunPositionDegree() + 'deg)';
        sky.style.oTransform = 'rotate(' + sunPositionDegree() + 'deg)';
        sky.style.transform = 'rotate(' + sunPositionDegree() + 'deg)';
    }
